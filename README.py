...
Students = [Student('Ruoy', 'Eman', 'your_gender'),
            Student('Kate', 'Petrova', 'your_gender')]
...
Students[1].rate_lecturer(Lecturers[1], 'C++', 7)
